            ...
            function select123(){    	
	        	...
	        	if(roleName == ""){
	        		alert("请输入角色名");
	        		 ...
	        		 location.href="${pageContext.request.contextPath}/SelectAdminByRoleName.do?roleName="+encodeURI(encodeURI(roleName));
	        	}
            }
        ...
        <div id="navi">
            <ul id="menu">
               <c:forEach items="${ad.lp}" var="pow">
            		<li><a href="${pow.purl}" class="${pow.pclass}"></a></li>
            	</c:forEach>
            </ul>
        </div>
        <!--导航区域结束-->
        ...
        <div id="main">
            <form action="" method="">
                ...
                <div class="search_add">
                    ...
                    <div>角色：<input type="text" value=""  class="text_search width200" name="rolename" id="role"/></div>
                    <div><input type="button" value="搜索" class="btn_search" id="selectRole" onclick="select123()"/></div>
